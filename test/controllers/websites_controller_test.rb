...
class WebsitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create website" do
    assert_difference('Website.count') do
      post websites_url, params: { website: { created_on: @website.created_on, name: @website.name } }
    end
  ...
  test "should update website" do
    patch website_url(@website), params: { website: { created_on: @website.created_on, name: @website.name } }
